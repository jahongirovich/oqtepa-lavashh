...
import hotDogImage from '../assets/xot dog.jpg';

const products = [
  { id: 1, title: 'Хот-дог', price: '19000', image: hotDogImage },
  { id: 2, title: 'Хот-дог с сыром', price: '21000', image: hotDogImage },
  { id: 3, title: 'Королевский Хот-дог', price: '28000', image: hotDogImage }
];

const BurgeriHotdogi = ({ addToCart }) => (
  <div className="w-full font-sans select-none">
    <div className="mb-6"><h3 className="text-[#1A1A1A] text-[22px] font-bold">Бургеры и Хот-доги</h3></div>
