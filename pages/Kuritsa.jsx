...
import chickenImage from '../assets/tovu.jpg';

const products = [
  { id: 1, title: 'Клаб сэндвич с фри', price: '43000', image: chickenImage },
  { id: 2, title: 'Клаб сэндвич без фри', price: '40000', image: chickenImage },
  { id: 3, title: 'Куриный Лооонгер', price: '27000', image: chickenImage }
];

const Kuritsa = ({ addToCart }) => (
  <div className="w-full font-sans select-none">
    <div className="mb-6"><h3 className="text-[#1A1A1A] text-[22px] font-bold">Курица</h3></div>
