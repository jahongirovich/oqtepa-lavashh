...
import desertiImage from '../assets/shirili.jpg';

const products = [
  { id: 1, title: 'Маффин шоколадный', price: '20000', image: desertiImage },
  { id: 2, title: 'Маффин лесные ягоды', price: '20000', image: desertiImage },
  { id: 3, title: 'Донат с орехом', price: '20000', image: desertiImage },
  { id: 4, title: 'Донат карамельный', price: '20000', image: desertiImage },
  { id: 5, title: 'Донат клубничный', price: '20000', image: desertiImage }
];

const Deserti = ({ addToCart }) => (
  <div className="w-full font-sans select-none">
    <div className="mb-6"><h3 className="text-[#1A1A1A] text-[22px] font-bold">Десерты</h3></div>
