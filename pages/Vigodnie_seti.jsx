...
import setiImage from '../assets/seti.jpg';

const products = [
  { id: 1, title: 'Hot dog seti', price: '25000', image: setiImage },
  { id: 2, title: 'Сет сырный хот дог', price: '30000', image: setiImage },
  { id: 3, title: 'Сет "Tovuqli loonger"', price: '40000', image: setiImage },
  { id: 4, title: 'Сет "Oqtepa Burger"', price: '50000', image: setiImage },
  { id: 5, title: 'Сет "Pita doner"', price: '50000', image: setiImage },
  { id: 6, title: 'Сет Lavash', price: '55000', image: setiImage }
];

const VigodnieSeti = ({ addToCart }) => (
  <div className="w-full font-sans select-none">
    <div className="mb-6"><h3 className="text-[#1A1A1A] text-[22px] font-bold">Выгодные сеты</h3></div>
